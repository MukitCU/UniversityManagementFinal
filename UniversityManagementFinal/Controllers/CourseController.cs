...
namespace UniversityManagementFinal.Controllers
{
    public class CourseController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "CourseId,CourseCode,CourseName,CourseCredit,CourseDescription,DepartmentId,SemesterId")] Course course)
        {
            ...
            {
                if (!db.Courses.Any(o => o.CourseCode == course.CourseCode))
                {
                    if (!db.Courses.Any(o => o.CourseName == course.CourseName))
                    {
                    ...
                    {
                        Response.Write("Course Name Already Exists");
                    }

                }
                else
                {
                    Response.Write("Course Code Already Exists");
                }
            }
